...
$sqlPre = "SELECT question, choices, quiz_image, correct_answer, additional_info 
           FROM quiz_questions_surfaceerosion
           WHERE type = 'pre' 
           ORDER BY RAND() 
           LIMIT 5";
                            ...
                            <div class="modal-content" id="activityContainer1">
                                <div class="box has-background-white-ter activity">
                                    ...
                                    <p class="subtitle has-text-centered has-text-grey is-size-3 mb-5 actStatement">
                                        Which of these could possibly be the causes of soil erosion?
                                    </p>
                                            ...
                                            <div class="columns is-multiline">
                                                ...
                                                <div class="column is-one-third">
                                                    <div class="box is-clickable has-background-grey-light imageAct" id="imageAct3">
                                                        <img src="../exerciseImage/dragSoil1.png" alt="Image 1" />
                                                    </div>
                                                </div>
                                                <!-- Bottom Row: 2 Images -->
                                                <div class="column is-one-third">
                                                    <div class="box is-clickable has-background-grey-light imageAct" id="imageAct4">
                                                        <img src="../exerciseImage/dragSoil2.png" alt="Image 1" />
                                                    </div>
                                                </div>
                                                <div class="column is-one-third">
                                    ...
                                    <div class="columns is-multiline">
                                        ...
                                        <div class="column is-half">
                                            <p class="subtitle has-text-left has-text-grey is-size-3 mb-5 actStatement2">
                                                What process refers to the wearing away or removal of the topmost layer of soil by natural forces such as water and wind?
                                            </p>
                                    ...
                                    <div class="columns is-multiline">
                                        <div class="column is-half">
                                            <div class="box has-background-grey-light imageAct2" id="imageAct10">
                                                <img src="../exerciseImage/dragSoil7.png" alt="Image 1" />
                                            </div>
                                            <div class="box has-background-grey-light imageAct2" id="imageAct11">
                                                <img src="../exerciseImage/dragSoil8.png" alt="Image 1" />
                                            </div>
                                        </div>
                                        
                                        <div class="column is-half">
                                            <div class="box has-background-grey-light imageAct2" id="imageAct12">
                                                <img src="../exerciseImage/dragSoil9.png" alt="Image 1" />
                                            </div>
                                            <div class="box has-background-grey-light imageAct2" id="imageAct13">
                                                <img src="../exerciseImage/dragSoil10.png" alt="Image 1" />
                                            </div>
                                        </div>

                                        <div class="column is-half">
                                            <p class="subtitle has-text-left has-text-grey is-size-3 actStatement3">
                                                What results when contaminants in the soil are lifted by the wind and carried into the air?
                                            </p>
                                            ...
                                            <div class="box letterChoicesBox">
                                                <div class="columns is-multiline">
                                                    <div class="column is-one-fifth">
                                                        <div class="box is-clickable tileLetter" id="letter1">P</div>
                                                    </div>
                                                    <div class="column is-one-fifth">
                                                        <div class="box is-clickable tileLetter" id="letter2">N</div>
                                                    </div>
                                                    <div class="column is-one-fifth">
                                                        <div class="box is-clickable tileLetter" id="letter3">O</div>
                                                    </div>
                                                    <div class="column is-one-fifth">
                                                        <div class="box is-clickable tileLetter" id="letter4">L</div>
                                                    </div>
                                                    <div class="column is-one-fifth">
                                                    ...
                                                    <div class="column is-one-fifth">
                                                        <div class="box is-clickable tileLetter" id="letter7">U</div>
                                                    </div>
                                                    <div class="column is-one-fifth">
                                                        <div class="box is-clickable tileLetter" id="letter8">Q</div>
                                                    </div>
                                                    <div class="column is-one-fifth">
                                                        <div class="box is-clickable tileLetter" id="letter9">T</div>
                                                    </div>
                                                    <div class="column is-one-fifth">
                            ...
                            <div class="columns is-centered">
                                ...
                                <div class="column is-half is-one-fifths is-flex is-flex-direction-column align-bottom mt-5">
                                    ...
                                    <figure class="image is-flex is-justify-content-center medal-image mt-5 mb-4">
                                        <img src="../../image/med8.png" alt="medal1">
                                    </figure>
                                </div>
                            </div>
                        </div>
...
<audio id="erosionAudio9" src="../../sounds/surfObj2.mp3"></audio>
<audio id="erosionAudio10" src="../../sounds/letsTry.mp3"></audio>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const audio9 = document.getElementById('erosionAudio9');
        const audio10 = document.getElementById('erosionAudio10');
        let currentSection = 0;
        const sections = [objectives, surfacePreAssessment, surfaceEffects, surfaceErosion, surfaceDetach, surfaceDesert, surfaceVideo, 
                            surfaceWater, surfaceSiltation, surfaceAir, surfacePrevent, surfaceActivity, letsTry, surfaceQuiz, surfaceCompleted];
            ...
            if (currentSection === sections.length - 1) {  // 'matterCompleted' is the last section
                ...
                if (data.status === 'taken') {
                    ...
                    const achievementData = {
                        student_id: studentId,
                        achievement_name: 'Earths Surface: Erosion',  
                        image_path: '../image/med8.png'  
                    };
        ...
        submitAct1.addEventListener('click', () => {
            ...
            const wrongImages = [imageAct1, imageAct2];
            ...
            const allCorrectImagesPlaced = [imageAct3, imageAct4, imageAct5].every(image =>
        ...
        submitAct2.addEventListener('click', function() {
            ...
            const correctAnswer = "soil erosion";
            if (!answer) {
        ...
        submitAct3.addEventListener('click', function() {
            ...
            if (answer === correctAnswer) {
                ...
                setTimeout(() => {
                    wrongAnswerModal.style.display = 'none';
                    noAnswerModal.querySelector('p').textContent = "Hint: 9 letters";
                    noAnswerModal.style.display = 'block';
        ...
        function updateEinsteinImageAndButtons() {
            if (currentSection === 12 || currentSection === 13 || currentSection === 13) {
        ...
        rightButton.addEventListener('click', function () {
            if (currentSection < sections.length + 1) {
                stopSectionTimer();
                if (sections[currentSection] === surfacePrevent) {
