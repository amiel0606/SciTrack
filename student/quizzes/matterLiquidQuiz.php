    ...
    const quizData = [
        {
            ...
            correctAnswer: 1 // index ng the tamang sagot
        },
        {
        ...
        },
        {
            ...
            answers: [
                "A. Molecules gain energy and move faster",
                "B. Molecules lose energy and move slower",
        ...
        function checkAnswer(selectedIndex) {
            ...
            if (selectedIndex === currentData.correctAnswer) {
                if (currentQuestionIndex === quizData.length - 1) {                
                    window.location.href = '../../student/matter/matterGas.php'; // Change to the appropriate href
                } else {
                    showCorrectModal();
