        ...
        const quizData = [
            {
                ...
                correctAnswer: 2 // index ng tamang sagot
            },
            {
       ...
       // Check Answer
        function checkAnswer(selectedIndex) {
            ...
            if (selectedIndex === currentData.correctAnswer) {
                if (currentQuestionIndex === quizData.length - 1) {                
                    window.location.href = '../../student/matter/matterLongQuiz.php'; // Change to the appropriate href
                } else {
                    showCorrectModal();
        ...
        rightButton.addEventListener('click', function () {
            if (currentQuestionIndex < quizData.length - 1) {
                ...
                window.location.href = '../../student/matter/matterLongQuiz.php';
            }
        });
        ...
        leftButton.addEventListener('click', function () {
            if (currentQuestionIndex > 0) {
                ...
                window.location.href = '../../student/matter/matterGas.php'; 
            }
        });
