...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const quizData = [
            ...
            {
                question: "What is a characteristic of a liquid?",
                answers: [
                    "A. Has a definite shape and volume",
                    "B. Has no definite shape but has volume",
                    "C. Has no definite shape and no definite volume",
            ...
            {
                question: "What happens to most liquids when they are heated?",
                answers: [
                    "A. Molecules lose energy and move closer together",
                    "B. Molecules gain energy and move faster",
                    "C. Liquids turn into solids",
                    "D. Liquids turn into gas"
                ],
                correctAnswer: 1
            },
            {
                question: "Which of these is NOT a property of liquids?",
                answers: [
                    "A. Liquids have a definite shape",
                    "B. Liquids can flow and take the shape of their container",
                    "C. Liquids have a definite volume",
                    "D. Liquids cannot be compressed easily"
                ],
                correctAnswer: 0
            },
            {
                ...
                answers: [
                    "A. Because their particles are tightly packed",
                    "B. Because their particles can move past each other",
                    "C. Because their particles are fixed in place",
                    "D. Because liquids have no volume"
                ],
                correctAnswer: 1
            },
            ...
            {
                question: "What is a characteristic of a gas?",
                answers: [
                    "A. Has a definite shape and volume",
                    "B. Has no definite shape but has volume",
                    "C. Has no definite shape and no definite volume",
                    "D. Can easily be compressed"
                ],
                correctAnswer: 2
            },
            {
            ...
            {
                question: "What happens to most gases when they are heated?",
                answers: [
                    "A. Molecules lose energy and move closer together",
                    "B. Molecules gain energy and spread further apart",
                    "C. Gases turn into liquids",
                    "D. Gases turn into solids"
                ],
                correctAnswer: 1
            },
            {
                question: "Which of these is NOT a property of gases?",
                answers: [
                    "A. Gases have a definite volume",
                    "B. Gases can fill their container",
                    "C. Gases can be compressed easily",
                    "D. Gases have low density"
                ],
                correctAnswer: 0
            },
            {
                question: "Why do gases have no definite shape?",
                answers: [
                    "A. Because their particles are tightly packed",
                    "B. Because their particles move freely and are far apart",
                    "C. Because their particles are fixed in place",
                    "D. Because gases have no volume"
                ],
                correctAnswer: 1
            }
        ];
        ...
        function checkAnswer(selectedIndex) {
            ...
            if (selectedIndex === currentData.correctAnswer) {
                if (currentQuestionIndex === quizData.length - 1) {                
                    window.location.href = 'nextPage.php'; // Change to the appropriate href
                } else {
                    showCorrectModal();
