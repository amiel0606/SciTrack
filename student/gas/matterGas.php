            ...
            <div class="columns is-centered is-vcentered">
                <div class="column is-full">
                    ...
                    <div class="gas-content" id="gasChar1">
                        <div class="is-overlay is-flex is-flex-direction-column is-align-items-center is-justify-content-center p-6">
                            <h1 class="title is-size-3-mobile is-size-1-tablet has-text-white mb-6">CHARACTERS OF GAS</h1>
                            ...
                            <div class="columns is-centered">
                                ...
                                <div class="column is-half mt-4">
                                    <ul class="title is-size-4-desktop is-size-5-tablet is-size-5-mobile has-text-white has-text-weight-semibold bullets">
                                        <li class="mb-5">Gases have neither definite shapenor definite volume. They expand to the size of their container.</li>
                                        <li class="mb-5">Gases are fluid, and flow easily.</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="columns is-centered">
                                ...
                                <div class="column is-half mt-4">
                                    <ul class="title is-size-4-desktop is-size-5-tablet has-text-white has-text-weight-semibold bullets">
                                        <li class="mb-5">Gases have low density, unless compressed. Being made of tiny particles in a large, open space, gases are very compressible.</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const sections = [gasExamples, gasDef, gasLearn, gasChar1, gasChar2, gasHappen];
        ...
        rightButton.addEventListener('click', function () {
            if (currentSection < sections.length - 1) {
                currentSection++;
                hideAllSections();
                sections[currentSection].classList.remove('gas-content');
                sections[currentSection].classList.add('gas-content-active');
            }
        });
