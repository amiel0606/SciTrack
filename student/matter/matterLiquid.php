                            ...
                            <div class="modal-content" id="activityContainer1">
                                <div class="box has-background-white-ter activity">
                                    ...
                                    <p class="subtitle has-text-centered has-text-grey is-size-3 mb-5 actStatement">
                                        Which of these are examples of liquid?
                                    </p>
                                            ...
                                            <div class="columns is-multiline">
                                                ...
                                                <div class="column is-one-third">
                                                    <div class="box is-clickable has-background-grey-light imageAct" id="imageAct5">
                                                        <img src="../exerciseImage/dragLiquid3.png" alt="Image 1" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="columns is-multiline">
                                        <div class="column is-half">
                                            ...
                                            <div class="box has-background-grey-light imageAct2" id="imageAct7">
                                                <img src="../exerciseImage/dragLiquid5.png" alt="Image 1" />
                                            </div>
                                        </div>
                                        
                                        <div class="column is-half">
                                            <div class="box has-background-grey-light imageAct2" id="imageAct8">
                                                <img src="../exerciseImage/dragLiquid6.png" alt="Image 1" />
                                            </div>
                                            <div class="box has-background-grey-light imageAct2" id="imageAct9">
                                                <img src="../exerciseImage/dragLiquid7.png" alt="Image 1" />
                                            </div>
                                        </div>

                                        <div class="column is-half">
                                            <p class="subtitle has-text-left has-text-grey is-size-3 mb-5 actStatement2">
                                                This thick liquid is sweet and flows slowly. It’s often used as a sweetener and can be sticky when it drips.
                                            </p>
                                    ...
                                    <div class="columns is-multiline">
                                        <div class="column is-half">
                                            <div class="box has-background-grey-light imageAct2" id="imageAct10">
                                                <img src="../exerciseImage/dragLiquid8.png" alt="Image 1" />
                                            </div>
                                            <div class="box has-background-grey-light imageAct2" id="imageAct11">
                                                <img src="../exerciseImage/dragLiquid9.png" alt="Image 1" />
                                            </div>
                                        </div>
                                        
                                        <div class="column is-half">
                                            <div class="box has-background-grey-light imageAct2" id="imageAct12">
                                                <img src="../exerciseImage/dragLiquid10.png" alt="Image 1" />
                                            </div>
                                            <div class="box has-background-grey-light imageAct2" id="imageAct13">
                                                <img src="../exerciseImage/dragLiquid11.png" alt="Image 1" />
                                            </div>
                                        </div>

                                        <div class="column is-half">
                                            <p class="subtitle has-text-left has-text-grey is-size-3 actStatement3">
                                                This liquid is used to give a pleasant scent. It comes in small, fancy bottles and is often sprayed on the skin or clothing.
                                            </p>
                                            ...
                                            <div class="box letterChoicesBox">
                                                <div class="columns is-multiline">
                                                    ...
                                                    <div class="column is-one-fifth">
                                                        <div class="box is-clickable tileLetter" id="letter2">P</div>
                                                    </div>
                                                    <div class="column is-one-fifth">
                                                        <div class="box is-clickable tileLetter" id="letter3">Z</div>
                                                    </div>
                                                    <div class="column is-one-fifth">
                                                    ...
                                                    <div class="column is-one-fifth">
                                                        <div class="box is-clickable tileLetter" id="letter8">H</div>
                                                    </div>
                                                    <div class="column is-one-fifth">
                                                        <div class="box is-clickable tileLetter" id="letter9">F</div>
                                                    </div>
                                                    <div class="column is-one-fifth">
                                                        <div class="box is-clickable tileLetter" id="letter10">R</div>
                                                    </div>
                            ...
                            <div class="columns is-centered">
                                ...
                                <div class="column is-half is-one-fifths is-flex is-flex-direction-column align-bottom mt-5">
                                    ...
                                    <figure class="image is-flex is-justify-content-center medal-image mt-5 mb-4">
                                        <img src="../../image/med1.png" alt="medal1">
                                    </figure>
                                </div>
                            </div>
                        </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const sections = [matterPreAssessment, matterStates, matterLiquid, matterChar, matterVideo, matterLiquid2, matterExamples, matterExamples2, matterActivity, matterLetsTry, matterQuiz, matterCompleted];
        ...
        submitAct1.addEventListener('click', () => {
            ...
            const wrongImages = [imageAct2, imageAct3];
            ...
            const allCorrectImagesPlaced = [imageAct1, imageAct4, imageAct5].every(image =>
