                            ...
                            <div class="is-centered">
                                ...
                                <div class="column is-full mt-4">
                                    <div class="subtitle description2 has-text-white">
                                        ...
                                        <p class="mb-5 main-font">Identify the correct standard unit for measuring distance</p>
                            ...
                            <div class="modal-content" id="activityContainer1">
                                <div class="box has-background-white-ter activity">
                                    ...
                                    <p class="subtitle has-text-centered has-text-grey is-size-3 mb-5 actStatement">
                                                Which of these tools are used for measuring distance or time?
                                    </p>
                                    ...
                                    <div class="columns is-multiline">
                                        <div class="column is-half">
                                            <div class="box has-background-grey-light imageAct2" id="imageAct6">
                                                <img src="../exerciseImage/dragMeasuring4.png" alt="Image 1" />
                                            </div>
                                            <div class="box has-background-grey-light imageAct2" id="imageAct7">
                                                <img src="../exerciseImage/dragMeasuring5.png" alt="Image 1" />
                                            </div>
                                        </div>
                                        
                                        <div class="column is-half">
                                            <div class="box has-background-grey-light imageAct2" id="imageAct8">
                                                <img src="../exerciseImage/dragMeasuring6.png" alt="Image 1" />
                                            </div>
                                            <div class="box has-background-grey-light imageAct2" id="imageAct9">
                                                <img src="../exerciseImage/dragMeasuring7.png" alt="Image 1" />
                                            </div>
                                        </div>

                                        <div class="column is-half">
                                            <p class="subtitle has-text-left has-text-grey is-size-3 mb-5 actStatement2">
                                                _______ is used for quantifying the size of objects or distances between objects, made of a thin metal sheet that can straighten up or fold.
                                            </p>
                                    ...
                                    <div class="columns is-multiline">
                                        <div class="column is-half">
                                            <div class="box has-background-grey-light imageAct2" id="imageAct10">
                                                <img src="../exerciseImage/dragMeasuring8.png" alt="Image 1" />
                                            </div>
                                            <div class="box has-background-grey-light imageAct2" id="imageAct11">
                                                <img src="../exerciseImage/dragMeasuring9.png" alt="Image 1" />
                                            </div>
                                        </div>
                                        
                                        <div class="column is-half">
                                            <div class="box has-background-grey-light imageAct2" id="imageAct12">
                                                <img src="../exerciseImage/dragMeasuring10.png" alt="Image 1" />
                                            </div>
                                            <div class="box has-background-grey-light imageAct2" id="imageAct13">
                                                <img src="../exerciseImage/dragMeasuring11.png" alt="Image 1" />
                                            </div>
                                        </div>

                                        <div class="column is-half">
                                            <p class="subtitle has-text-left has-text-grey is-size-3 actStatement3">
                                                What is an electric device used to measure the distance traveled by a vehicle?
                                            </p>
                                            ...
                                            <div class="box letterChoicesBox">
                                                <div class="columns is-multiline">
                                                    <div class="column is-one-fifth">
                                                        <div class="box is-clickable tileLetter" id="letter1">O</div>
                                                    </div>
                                                    <div class="column is-one-fifth">
                                                    ...
                                                    <div class="column is-one-fifth">
                                                        <div class="box is-clickable tileLetter" id="letter7">E</div>
                                                    </div>
                                                    <div class="column is-one-fifth">
                                                        <div class="box is-clickable tileLetter" id="letter8">Q</div>
                                                    </div>
                                                    <div class="column is-one-fifth">
                                                        <div class="box is-clickable tileLetter" id="letter9">M</div>
                                                    </div>
                                                    <div class="column is-one-fifth">
                                                        <div class="box is-clickable tileLetter" id="letter10">T</div>
                                                    </div>
                            ...
                            <div class="columns is-centered">
                                ...
                                <div class="column is-half is-one-fifths is-flex is-flex-direction-column align-bottom mt-5">
                                    ...
                                    <figure class="image is-flex is-justify-content-center medal-image mt-5 mb-4">
                                        <img src="../../image/med6.png" alt="medal1">
                                    </figure>
                                </div>
                            </div>
                        </div>
...
<audio id="motionAudio9" src="../../sounds/motionObj2.mp3"></audio>
<audio id="motionAudio10" src="../../sounds/letsTry.mp3"></audio>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const sections = [objectives, motionPreAssessment, motionMeasuring1, motionMeasuring2, motionRuler, motionTape, motionOdo, motionSpeedo, 
                            motionSurvey, motionCaliper, motionMicrometer,  motionVideo, motionActivity, letsTry, motionQuiz, motionCompleted];
            ...
            if (currentSection === sections.length - 1) {  // 'matterCompleted' is the last section
                ...
                if (data.status === 'taken') {
                    ...
                    const achievementData = {
                        student_id: studentId,
                        achievement_name: 'Motion: Measuring Distance and Time',  
                        image_path: '../image/med6.png'  
                    };
        ...
        submitAct1.addEventListener('click', () => {
            ...
            const wrongImages = [imageAct1, imageAct4];
            ...
            const allCorrectImagesPlaced = [imageAct2, imageAct3, imageAct5].every(image =>
        ...
        submitAct2.addEventListener('click', function() {
            ...
            const correctAnswer = "tape measure";
            if (!answer) {
            ...
            if (answer === correctAnswer) {
                ...
                setTimeout(() => {
                    wrongAnswerModal.style.display = 'none';
                    noAnswerModal.querySelector('p').textContent = "Hint: 2 words";
                    noAnswerModal.style.display = 'block';
        ...
        function updateEinsteinImageAndButtons() {
            if (currentSection === 13 || currentSection === 14 || currentSection === 15) {
            ...
            if (currentSection === 13 || currentSection === 15) {
        ...
        rightButton.addEventListener('click', function () {
            if (currentSection < sections.length + 1) {
                stopSectionTimer();
                if (sections[currentSection] === motionVideo) {
