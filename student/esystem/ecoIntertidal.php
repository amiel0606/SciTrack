...
$sqlPre = "SELECT question, choices, quiz_image, correct_answer, additional_info 
           FROM quiz_questions_intertidal
           WHERE type = 'pre' 
           ORDER BY RAND() 
           LIMIT 5";
        ...
        <div class="container">
            <div class="columns is-centered is-vcentered">
                <div class="column is-full">
                    ...
                    <!-- Pre-Assessment -->
                    <div class="eco-content" id="ecoPreAssessment">
                        <div class="is-overlay is-flex is-flex-direction-column is-align-items-center is-justify-content-center p-6"
                            style="z-index: 1;">
                        ...
                        <div class="is-overlay is-flex is-flex-direction-column is-align-items-center is-justify-content-center mb-6 p-6">
                            ...
                            <div class="columns is-vcentered is-mobile is-multiline">
                                ...
                                <div class="column is-5" id="eco-text">
                                    <p class="title main-font is-size-5-tablet is-size-3-desktop is-size-2-widescreen has-text-white has-text-justified tight-spacing">
                    ...
                    <!-- Eco Activity -->
                    <div class="eco-content" id="ecoActivity">
                        <div class="modal">
                            <!-- Modal Background -->
                            ...
                            <div class="modal-content" id="activityContainer1">
                                <div class="box has-background-white-ter activity">
                                    ...
                                    <p class="subtitle has-text-centered has-text-grey is-size-3 mb-5 actStatement">
                                        Which of these organisms can be found in the High Tide Zone?
                                    </p>
                                            ...
                                            <div class="columns is-multiline">
                                                ...
                                                <div class="column is-one-third">
                                                    <div class="box is-clickable has-background-grey-light imageAct" id="imageAct1">
                                                        <img src="../exerciseImage/dragInt1.png" alt="Image 1" />
                                                    </div>
                                                </div>
                                                <div class="column is-one-third">
                                                ...
                                                <div class="column is-one-third">
                                                    <div class="box is-clickable has-background-grey-light imageAct" id="imageAct3">
                                                        <img src="../exerciseImage/dragInt2.png" alt="Image 1" />
                                                    </div>
                                                </div>
                                                <!-- Bottom Row: 2 Images -->
                                                <div class="column is-one-third">
                                                    <div class="box is-clickable has-background-grey-light imageAct" id="imageAct4">
                                                        <img src="../exerciseImage/dragEst2.png" alt="Image 1" />
                                                    </div>
                                                </div>
                                                <div class="column is-one-third">
                                    ...
                                    <div class="columns is-multiline">
                                        <div class="column is-half">
                                            <div class="box has-background-grey-light imageAct2" id="imageAct10">
                                                <img src="../exerciseImage/dragInt8.png" alt="Image 1" />
                                            </div>
                                            <div class="box has-background-grey-light imageAct2" id="imageAct11">
                                                <img src="../exerciseImage/dragInt9.png" alt="Image 1" />
                                            </div>
                                        </div>
                                        
                                        <div class="column is-half">
                                            <div class="box has-background-grey-light imageAct2" id="imageAct12">
                                                <img src="../exerciseImage/dragInt10.png" alt="Image 1" />
                                            </div>
                                            <div class="box has-background-grey-light imageAct2" id="imageAct13">
                                                <img src="../exerciseImage/dragInt11.png" alt="Image 1" />
                                            </div>
                                        </div>

                                        <div class="column is-half">
                                            <p class="subtitle has-text-left has-text-grey is-size-3 actStatement3">
                                                _______ refers to the movement of water as a result of the gravitational pull of the sun and the moon.
                                            </p>
                                            ...
                                            <div class="box letterChoicesBox">
                                                <div class="columns is-multiline">
                                                    <div class="column is-one-fifth">
                                                        <div class="box is-clickable tileLetter" id="letter1">E</div>
                                                    </div>
                                                    <div class="column is-one-fifth">
                                                    ...
                                                    <div class="column is-one-fifth">
                                                        <div class="box is-clickable tileLetter" id="letter5">T</div>
                                                    </div>
                                                    <div class="column is-one-fifth">
...
<audio id="ecoEstAudio8" src="../../sounds/ecoObj2.mp3"></audio>
<audio id="ecoEstAudio9" src="../../sounds/letsTry.mp3"></audio>
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const ecoPreAssessment = document.getElementById('ecoPreAssessment');
        ...
        const ecoActivity = document.getElementById('ecoActivity');
        ...
        const sections = [objectives, ecoPreAssessment, eco1, eco2, eco3, ecoVideo, eco4, ecoSplash, eco5, ecoHigh, eco6, ecoMiddle, ecoMiddle2, eco7, ecoLow, ecoLow2, ecoActivity, letsTry, ecoQuiz, ecoCompleted];
            ...
            if (currentSection === sections.length - 1) {  // 'matterCompleted' is the last section
                ...
                if (data.status === 'taken') {
                    ...
                    const achievementData = {
                        student_id: studentId,
                        achievement_name: 'Ecosystem: Intertidal',  
        ...
        submitAct1.addEventListener('click', () => {
            ...
            const wrongImages = [imageAct2, imageAct4];
            ...
            const allCorrectImagesPlaced = [imageAct1, imageAct3, imageAct5].every(image =>
        ...
        function updateEinsteinImageAndButtons() {
            if (currentSection === 17 || currentSection === 18 || currentSection === 19) {
            ...
            if (currentSection === 17 || currentSection === 19) {
        ...
        rightButton.addEventListener('click', function () {
            if (currentSection < sections.length + 1) {
                stopSectionTimer();
                if (sections[currentSection] === ecoLow2) {
                    currentSection = sections.indexOf(ecoActivity);
