                            ...
                            <div class="modal-content" id="activityContainer1">
                                <div class="box has-background-white-ter activity">
                                    ...
                                    <p class="subtitle has-text-centered has-text-grey is-size-3 mb-5 actStatement">
                                        Which of these are examples of Biotic factors?
                                    </p>
                                            ...
                                            <div class="columns is-multiline">
                                                ...
                                                <div class="column is-one-third">
                                                    <div class="box is-clickable has-background-grey-light imageAct" id="imageAct3">
                                                        <img src="../exerciseImage/dragEst1.png" alt="Image 1" />
                                                    </div>
                                                </div>
                                                <!-- Bottom Row: 2 Images -->
                                                <div class="column is-one-third">
                                                ...
                                                <div class="column is-one-third">
                                                    <div class="box is-clickable has-background-grey-light imageAct" id="imageAct5">
                                                        <img src="../exerciseImage/dragEst3.png" alt="Image 1" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="columns is-multiline">
                                        <div class="column is-half">
                                            ...
                                            <div class="box has-background-grey-light imageAct2" id="imageAct7">
                                                <img src="../exerciseImage/dragEst5.png" alt="Image 1" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="column is-half">
                                            ...
                                            <div class="box has-background-grey-light imageAct2" id="imageAct9">
                                                <img src="../exerciseImage/dragEst7.png" alt="Image 1" />
                                            </div>
                                        </div>

                                        <div class="column is-half">
                                            <p class="subtitle has-text-left has-text-grey is-size-3 mb-5 actStatement2">
                                                The water in an estuary looks cloudy because of sediments and helps small organisms hide. What is this water called?
                                            </p>
                                    ...
                                    <div class="columns is-multiline">
                                        <div class="column is-half">
                                            <div class="box has-background-grey-light imageAct2" id="imageAct10">
                                                <img src="../exerciseImage/dragEst8.png" alt="Image 1" />
                                            </div>
                                            <div class="box has-background-grey-light imageAct2" id="imageAct11">
                                                <img src="../exerciseImage/dragEst9.png" alt="Image 1" />
                                            </div>
                                        </div>
                                        
                                        <div class="column is-half">
                                            <div class="box has-background-grey-light imageAct2" id="imageAct12">
                                                <img src="../exerciseImage/dragEst10.png" alt="Image 1" />
                                            </div>
                                            <div class="box has-background-grey-light imageAct2" id="imageAct13">
                                                <img src="../exerciseImage/dragEst11.png" alt="Image 1" />
                                            </div>
                                        </div>

                                        <div class="column is-half">
                                            <p class="subtitle has-text-left has-text-grey is-size-3 actStatement3">
                                                What is the term for all the biotic and abiotic factors that interact within an area at once?
                                            </p>
                                            ...
                                            <div class="box letterChoicesBox">
                                                <div class="columns is-multiline">
                                                    <div class="column is-one-fifth">
                                                        <div class="box is-clickable tileLetter" id="letter1">M</div>
                                                    </div>
                                                    <div class="column is-one-fifth">
                                                        <div class="box is-clickable tileLetter" id="letter2">E</div>
                                                    </div>
                                                    <div class="column is-one-fifth">
                                                        <div class="box is-clickable tileLetter" id="letter3">T</div>
                                                    </div>
                                                    <div class="column is-one-fifth">
                                                        <div class="box is-clickable tileLetter" id="letter4">Y</div>
                                                    </div>
                                                    <div class="column is-one-fifth">
                                                        <div class="box is-clickable tileLetter" id="letter5">E</div>
                                                    </div>
                                                    <div class="column is-one-fifth">
                                                        <div class="box is-clickable tileLetter" id="letter6">S</div>
                                                    </div>
                                                    <div class="column is-one-fifth">
                                                        <div class="box is-clickable tileLetter" id="letter7">S</div>
                                                    </div>
                                                    <div class="column is-one-fifth">
                                                        <div class="box is-clickable tileLetter" id="letter8">Q</div>
                                                    </div>
                                                    <div class="column is-one-fifth">
                                                        <div class="box is-clickable tileLetter" id="letter9">O</div>
                                                    </div>
                                                    <div class="column is-one-fifth">
                                                        <div class="box is-clickable tileLetter" id="letter10">C</div>
                                                    </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        .then(data => {
            if (data.status === 'taken') {
                ...
                const achievementData = {
                    student_id: studentId,
                    achievement_name: 'Ecosystem: Estuaries',  
        ...
        function updateEinsteinImageAndButtons() {
            if (currentSection === 3 || currentSection === 14 || currentSection === 15  || currentSection === 16) {
        ...
        rightButton.addEventListener('click', function () {
            if (currentSection < sections.length + 1) {
                stopSectionTimer();
                if (sections[currentSection] === eco5) {
