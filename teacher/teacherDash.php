        ...
        <div class="columns">
            <div class="column is-two-thirds">
                <div class="box dash has-shadow">
                    ...
                    <p class="has-text-primary is-size-1 has-text-left mt-1 has-text-weight-bold ">Welcome back, Teacher
                    </p>
                    <p class="has-text-primary is-size-3 has-text-left ">Great Day Ahead!</p>
            ...
            success: function (response) {
                ...
                Object.values(studentProgress).forEach(function (student) {
                    ...
                    <tr class="clickable-row" data-student-id="${student.id}">
                        ...
                        <td class="is-progress">
                            <progress class="progress is-success is-small" value="${progressPercentage}" max="100">${progressPercentage}%</progress>
                        </td>
