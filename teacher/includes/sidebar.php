        ...
        <ul class="menu-list">
                <li>
                    <p class="menu-item has-background-primary mb-6 "><i
                            ...
                            class="text has-text-white is-size-1"><?php echo $_SESSION['firstName'] ?></span></p>
                </li>
                <li><a href="./teacherDash.php" class="menu-item has-background-primary mt-6"><i
                ...
                <li><a href="./assessmentResult.php" class="menu-item has-background-primary mt-6"><i
